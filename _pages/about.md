...
<div class="lang-panel lang-panel--zh" markdown="1">
...
- *2025.11.02* 🎉 ACM-ICPC国际大学生程序设计竞赛亚洲区域赛(武汉站) **金奖**
- *2025.10.19* 🎉 ACM-ICPC国际大学生程序设计竞赛亚洲区域赛(西安站) **金奖**
- *2024.10 — 2025.10* 省部级大创项目《融合视觉感知与群智能优化的无人分拣车路径规划与调度》（核心成员）
- *2025.9* 第八届牛客暑期多校训练营 **二等奖**
- *2025.8.30* 第21届百度之星程序设计大赛决赛（人才专项赛道）（码蹄杯） **国金奖**
- *2025.8.25* 第21届百度之星程序设计大赛初赛（省赛）**省银奖**
...
*2026年全国大学生电子设计竞赛C题* ***2026年全国大学生电子设计竞赛山东赛区三等奖***
...
**主要成果**
- 四态门锁逻辑：3m感应/2m迎宾/1m开锁，5次连续确认+10cm回差，丢包安全闭锁
...
<span class='anchor' id='en-news'></span>
...
*2026 National Undergraduate Electronic Design Contest — Problem C* ***Third Prize, 2026 NUEDC Shandong Provincial***
...
**Key Results**
- Four-state lock logic: 3m sense / 2m welcome / 1m unlock; 5-sample confirmation, 10cm hysteresis, safe lock on packet loss
...
*Assoc. Prof. Cui Shiyao's Group · Provincial University Student Innovation Project*

We address low recognition accuracy, unsafe path planning, and inefficient multi-vehicle scheduling in warehouse sorting by integrating **YOLOv5** detection, improved **A\*** planning, **GA** for TSP, **PSO**, and **VNS** for multi-vehicle coordination.

**Key Results**
- YOLOv5 detection accuracy **89.69%** (3,200 augmented images, 200 training epochs)
- Improved A\* reduced adjacent-obstacle encounters by **89.7%** (29 → 3) vs. standard A\*
- 30-task TSP redundancy reduced by **16.8%**; multi-vehicle PSO error < **9.4%**, **90%+** faster than CPLEX
- VNS for pickup-delivery constraints saved ~**20%** cost vs. traditional delivery
